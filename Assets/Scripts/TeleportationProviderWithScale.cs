...
namespace Spacebar
{
    ...
    public class TeleportationProviderWithScale : LocomotionProvider
    {
        /// <summary>
        ...
        {
            Debug.Log("QueueTeleportRequest");
        ...
        {
            Debug.Log("TeleportationProvider Awake");
