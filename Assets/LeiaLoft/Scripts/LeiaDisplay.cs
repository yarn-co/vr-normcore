...
#pragma warning disable CS0618 // Type or member is obsolete
        ...
        private class CNSDKHolder
        {
            ...
            public static void Initialize()
            {
                ...
                Leia.PlatformInitArgs platformInitArgs = new Leia.PlatformInitArgs();
                platformInitArgs.logLevel = Leia.LogLevel.Debug; // Leia.LogLevel.Off;
                _cnsdk.InitializePlatform(platformInitArgs);

                if (Leia.SDK.IsFaceTrackingInService())
                {
                    _cnsdk.InitializeFaceTrackingInService(false, Leia.LogLevel.Default, true, true);
                }
                else
                {
                    _cnsdk.InitializeFaceTrackingInApp(false);
                }
                ...
                {
                    LogUtil.Log(LogLevel.Error, "Interlacer error: {0}", e);
                }
            }
        }
